...
describe('Town Selection', () => {
  ...
  describe('Creating and joining towns', () => {
    ...
    beforeEach(async () => {
      ...
      userNameField = renderData.getAllByPlaceholderText('Your username')[0] as HTMLInputElement;
    ...
    describe('Joining existing towns', () => {
      describe('Joining an existing town by ID', () => {
        ...
        // TODO: try to remove skip
        it.skip('includes a connect button, which creates a new TownController and connects with the entered username and coveyTownID', async () => {
        ...
        // TODO: try to remove skip
        it.skip('displays an error toast "Unable to join town" if the TownID is empty', async () => {
          const userName = nanoid();
          await joinTownWithOptions({
            coveyTownID: '',
            userName,
        ...
        // TODO: try to remove skip
        it.skip('displays an error toast "Unable to connect to Towns Service" if an error occurs', async () => {
          const coveyTownID = nanoid();
          const userName = nanoid();
      ...
      describe('Joining an existing town from public town table', () => {
        // TODO: try to remove skip
        it.skip('includes a connect button in each row, which calls Video.setup, doLogin, and connect with the entered username and coveyTownID corresponding to that town', async () => {
          const rows = renderData.getAllByRole('row');
    ...
    describe('Creating a new town', () => {
      ...
      describe('when clicking create', () => {
        ...
        describe('with valid values', () => {
          ...
          // TODO: try to remove skip
          it.skip('after success, creates a new TownController and connects with the entered username and newly generated townID', async () => {
            const townID = nanoid();
            const roomPassword = nanoid();
            const userName = nanoid();
            const townName = nanoid();
