        ...
        <Stack>
          <Box p='4' borderWidth='1px' borderRadius='lg'>
            ...
            <Tabs isFitted variant='enclosed'>
              <TabList>
                <Tab onClick={handleLoginClick} color={showLogin ? 'blue' : 'gray'}>
                  Login
                </Tab>
                <Tab onClick={handleSignUpClick} color={showSignUp ? 'blue' : 'gray'}>
                  Sign Up
                </Tab>
              </TabList>
              <TabPanels>
                <TabPanel>{accountInfo.accountInfo}</TabPanel>
                <TabPanel>{accountInfo.accountInfo}</TabPanel>
              </TabPanels>
            </Tabs>
          </Box>
