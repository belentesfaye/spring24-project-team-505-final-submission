...
export default abstract class InteractableArea {
  ...
  /**
   * Emits an event to the players in the town notifying them currency has been updated
   */
  protected _emitCoinsChanged() {
    this._townEmitter.emit('coinsChanged');
  }

  /**
   * Emits an event to the players in the town notifying them currency has been updated
   */
  // protected _emitPetsChanged() {
  //   this._townEmitter.emit('petsChanged');
  // }
